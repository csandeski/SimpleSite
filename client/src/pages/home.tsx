    ...
    <main className="min-h-screen bg-[hsl(var(--color-bg))]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="hidden md:flex relative z-10 max-w-6xl mx-auto flex-col items-center justify-end min-h-[700px] px-4 pb-12">
          ...
          <h1 className="text-2xl md:text-4xl font-bold leading-tight text-center mb-4 text-[hsl(var(--color-text))] max-w-3xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] -mt-20" data-testid="text-hero-title-desktop">
      ...
      <section className="md:hidden relative -mt-16 pt-4 px-4">
        <div className="max-w-6xl mx-auto">
          {/* Main headline positioned to overlap the image */}
          <h1 className="text-xl md:text-2xl font-bold leading-tight text-center mb-4 text-[hsl(var(--color-text))] drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]" data-testid="text-hero-title">
            Tenha acesso as 5 peças de crochê mais vendidas do meu ateliê
          </h1>
